...
@section('title', $state->display_name . ' - द पब्लिक एक्सप्रेस')

@section('content')
    <div class="mb-6">
        <h1 class="text-2xl md:text-3xl font-black text-slate-950">📍 {{ $state->display_name }} की ताजा खबरें</h1>
        <p class="text-sm text-slate-500 mt-1">राज्य की सभी महत्वपूर्ण खबरें यहाँ पढ़ें</p>
    </div>
