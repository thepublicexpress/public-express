...
<body class="flex items-center justify-center min-h-screen p-4">
    ...
    <div class="w-full max-w-md bg-white rounded-2xl shadow-xl overflow-hidden">
        <div class="bg-brand p-4 text-center">
            ...
            <p class="text-white/80 text-sm">रिपोर्टर लॉगिन</p>
        </div>
        ...
        <div class="p-6">
            ...
            <form action="{{ route('reporter.login.post') }}" method="POST">
                @csrf
                <div class="mb-4">
                ...
                <p class="text-center mt-4 text-sm text-gray-600">
                    क्या आप नए हैं? 
                    <a href="{{ route('reporter.register') }}" class="text-brand font-bold">रजिस्टर करें</a>
                </p>
            </form>
        </div>
