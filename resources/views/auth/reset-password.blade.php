...
<head>
    ...
    <title>पासवर्ड रीसेट - द पब्लिक एक्सप्रेस</title>
...
<div class="card">
    <div class="text-center mb-6">
        ...
        <p class="text-sm text-gray-500">🔑 नया पासवर्ड सेट करें</p>
    </div>
    ...
    <form method="POST" action="{{ route('password.update') }}">
        ...
        <div class="mb-3">
            <label class="block text-sm font-bold text-gray-700 mb-1">🔑 नया पासवर्ड</label>
        ...
        <button type="submit" class="btn-primary">
            <i class="fas fa-save mr-2"></i> पासवर्ड सेट करें
        </button>
    </form>
