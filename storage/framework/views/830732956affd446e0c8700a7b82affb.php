...
<div class="login-card">
    ...
    <form method="POST" action="<?php echo e(route('login.post')); ?>">
        ...
        <div class="text-right mb-4">
            <a href="<?php echo e(route('password.request')); ?>" class="text-sm text-brand hover:underline font-bold">
                🔓 पासवर्ड भूल गए?
            </a>
        </div>
    ...
    <!-- OTP Login Button -->
    <a href="<?php echo e(route('otp.login')); ?>" class="btn-otp inline-block text-center">
    ...
    <div class="mt-4 text-center text-sm text-gray-600">
        अकाउंट नहीं है? 
        <a href="<?php echo e(route('register')); ?>" class="text-brand font-bold hover:underline">
            रजिस्टर करें
        </a>
    </div>
...
</html><?php /**PATH C:\xampp\htdocs\public-express\resources\views/auth/login.blade.php ENDPATH**/ ?>